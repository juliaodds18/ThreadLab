...
def draw_ascii(sleeptime):
    os.system('clear')
    print(board.format(vertCross=color(Fore.RED,
                                       "{:^3}".format(crossing[0])),
                       vertCarCross=color(Fore.YELLOW,
                                          "{:^7}".format(crossing[1])),
                       horCross=color(Fore.BLUE,
                                      "{:^7}".format(crossing[2])),
                       horCarCross=color(Fore.GREEN,
                                         "{:^3}".format(crossing[3])),
                       vertWait=color(Fore.RED,
                                      "{:^3}".format(waiting[0])),
                       vertCarWait=color(Fore.YELLOW,
                                         "{:^7}".format(waiting[1])),
                       horWait=color(Fore.BLUE,
                                     "{:^3}".format(waiting[2])),
                       horCarWait=color(Fore.GREEN,
                                        "{:^3}".format(waiting[3]))))
    print("{:>35}".format("--=Fairness=--"))
    print("{:>35}".format("Vertical Pedestrians: %s" % color(Fore.RED,
                                                             fairness[0])))
    print("{:>35}".format("Horizontal Pedestrians: %s" % color(Fore.BLUE,
                                                               fairness[2])))
    print("{:>35}".format("Vertical Cars: %s" % color(Fore.YELLOW,
                                                      fairness[1])))
